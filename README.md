...
Built on **Solana**, $LUCIIID transforms faith into a measurable force of creation — where every holder becomes a believer, every believer becomes a creator, and every creation feeds back into the light.
...
- Trade and collect using $LUCIIID  
...
- [Whitepaper](./whitepaper.md) — The Manifesto of Belief  
- [Tokenomics](./TOKENOMICS.md) — Allocation & Supply  
- [Creators Market](./creators_market.md) — Marketplace Framework  
- [Security](./SECURITY.md) — Mint, Freeze & LP Proofs  
- [addresses.json](./addresses.json) — Verified Wallet Registry  
- [vesting.csv](./vesting.csv) — Distribution Transparency  

All documents are auditable and stored permanently on this GitHub repository.
